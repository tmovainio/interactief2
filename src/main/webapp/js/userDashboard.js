...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var session, rankingResponse, ranking;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                document.getElementById("phoneNumber").value = session.user.phone_numb;
                document.getElementById("profileStudentNumber").innerText = session.user.s_numb.toString();
                return [4, sendGet("leaderboard/".concat(session.team.team_name), { "Authorization": getToken() })];
            case 2:
                rankingResponse = _a.sent();
                return [4, rankingResponse.json()];
            case 3:
                ranking = (_a.sent()).score;
