...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var urlParams, problemId, res, puzzle, fileRes, reader, _a, _b, locations, locationSelector;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4, res.json()];
            case 2:
                puzzle = (_c.sent()).puzzle;
                return [4, sendGet("puzzles/".concat(problemId, "/file"), { "Authorization": getToken() })];
            case 3:
                fileRes = _c.sent();
                if (!(fileRes.status === 404)) return [3, 4];
                document.getElementById("descriptionImage").src = "/images/University_of_Twente_panoramic.jpg";
                return [3, 6];
            case 4:
                reader = new FileReader();
                reader.onload = function (e) {
                    document.getElementById("descriptionImage").src = e.target.result.toString();
                };
...
//# sourceMappingURL=committeePuzzle.js.map