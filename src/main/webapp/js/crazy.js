...
var createCrazy88Element = function (crazy88) {
    ...
    a.innerText = "Open";
    a.href = "commitee-crazy-specific.html?problem_id=".concat(crazy88.problem_id);
    card.appendChild(a);
